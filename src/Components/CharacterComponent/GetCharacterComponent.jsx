...
import PostChararcterComponent from './PostChararcterComponent';
import './GetCharacterComponent.css'
  ...
  return (
    ...
    <div className='character'>
        {rickData && rickData.map((iterator, index) => (
            <PostChararcterComponent charData={iterator} key={index} />
        ))}
    </div>
...
export default GetCharacterComponent